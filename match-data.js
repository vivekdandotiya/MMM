...
const squadData = {
  "CSK": ["Ruturaj Gaikwad (c) 🏏", "Dewald Brevis 🏏", "MS Dhoni (wk) 🧤", "Kartik Sharma (wk) 🧤", "Sarfaraz Khan 🏏", "Ayush Mhatre 🏏", "Urvil Patel (wk) 🧤", "Sanju Samson (wk) 🧤", "Aman Khan ⚡", "Shivam Dube ⚡", "Zak Foulkes ⚡", "Ramakrishna Ghosh ⚡", "Anshul Kamboj ⚡"],
  "RCB": ["Rajat Patidar (c) 🏏", "Jordan Cox (wk) 🧤", "Tim David 🏏", "Virat Kohli 🏏", "Devdutt Padikkal 🏏", "Phil Salt (wk) 🧤", "Jitesh Sharma (wk) 🧤", "Jacob Bethell ⚡", "Kanishk Chouhan ⚡", "Venkatesh Iyer ⚡", "Vihaan Malhotra ⚡", "Mangesh Yadav ⚡", "Krunal Pandya ⚡"],
  "MI": ["Hardik Pandya (c) ⚡", "Quinton de Kock (wk) 🧤", "Danish Malewar 🏏", "Robin Minz (wk) 🧤", "Ryan Rickelton (wk) 🧤", "Sherfane Rutherford 🏏", "Rohit Sharma 🏏", "Suryakumar Yadav 🏏", "Atharva Ankolekar ⚡", "Raj Bawa ⚡", "Corbin Bosch ⚡", "Will Jacks ⚡", "Mayank Rawat ⚡"],
  "KKR": ["Ajinkya Rahane (c) 🏏", "Rinku Singh 🏏", "Finn Allen 🏏", "Tejasvi Dahiya (wk) 🧤", "Manish Pandey 🏏", "Rovman Powell 🏏", "Angkrish Raghuvanshi 🏏", "Ramandeep Singh 🏏", "Sarthak Ranjan 🏏", "Tim Seifert (wk) 🧤", "Rahul Tripathi 🏏", "Daksh Kamra ⚡", "Cameron Green ⚡"],
  "RR": ["Riyan Parag (c) 🏏", "Aman Rao 🏏", "Shubham Dubey 🏏", "Shimron Hetmyer 🏏", "Yashasvi Jaiswal 🏏", "Dhruv Jurel (wk) 🧤", "Lhuan-dre Pretorius (wk) 🧤", "Ravi Singh 🏏", "Vaibhav Sooryavanshi 🏏", "Donovan Ferreira ⚡", "Ravindra Jadeja ⚡", "Dasun Shanaka ⚡", "Jofra Archer ⚾"],
  "SRH": ["Ishan Kishan (c)(wk) 🧤", "Salil Arora (wk) 🧤", "Travis Head 🏏", "Heinrich Klaasen (wk) 🧤", "Ravichandran Smaran 🏏", "Aniket Verma 🏏", "Abhishek Sharma ⚡", "Brydon Carse ⚡", "Harsh Dubey ⚡", "Krains Fuletra ⚡", "Liam Livingstone ⚡", "Kamindu Mendis ⚡", "Nitish Kumar Reddy ⚡"],
  "DC": ["Axar Patel (c) ⚡", "Abishek Porel (wk) 🧤", "David Miller 🏏", "Karun Nair 🏏", "Pathum Nissanka 🏏", "Sahil Parakh 🏏", "KL Rahul (wk) 🧤", "Nitish Rana 🏏", "Prithvi Shaw 🏏", "Tristan Stubbs (wk) 🧤", "Ajay Mandal ⚡", "Sameer Rizvi ⚡", "Ashutosh Sharma ⚡"],
  "PBKS": ["Shreyas Iyer (c) 🏏", "Priyansh Arya 🏏", "Pyla Avinash 🏏", "Harnoor Singh 🏏", "Prabhsimran Singh (wk) 🧤", "Vishnu Vinod (wk) 🧤", "Nehal Wadhera 🏏", "Azmatullah Omarzai ⚡", "Cooper Connolly ⚡", "Marco Jansen ⚡", "Musheer Khan ⚡", "Mitchell Owen ⚡", "Shashank Singh ⚡"],
  "GT": ["Shubman Gill (c) 🏏", "Anuj Rawat (wk) 🧤", "Tom Banton (wk) 🧤", "Jos Buttler (wk) 🧤", "Kumar Kushagra (wk) 🧤", "Sai Sudharsan 🏏", "M Shahrukh Khan 🏏", "Jason Holder ⚡", "Glenn Phillips ⚡", "Rashid Khan ⚡", "Nishant Sindhu ⚡", "Manav Suthar ⚡", "Rahul Tewatia ⚡"],
  "LSG": ["Rishabh Pant (c)(wk) 🧤", "Abdul Samad 🏏", "Akshat Raghuwanshi 🏏", "Ayush Badoni 🏏", "Matthew Breetzke 🏏", "Mukul Choudhary 🏏", "Himmat Singh 🏏", "Josh Inglis (wk) 🧤", "Aiden Markram 🏏", "Nicholas Pooran (wk) 🧤", "Wanindu Hasaranga ⚡", "Arshin Kulkarni ⚡", "Mitchell Marsh ⚡"]
};
