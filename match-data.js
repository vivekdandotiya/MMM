...
const squadData = {
  "CSK": ["Ruturaj Gaikwad (c) 🏏", "Sanju Samson (wk) 🧤", "MS Dhoni (wk) 🧤", "Shivam Dube ⚡", "Dewald Brevis 🏏", "Prashant Veer 🏏", "Kartik Sharma 🏏", "Jamie Overton ⚡", "Noor Ahmad ⚾", "Khaleel Ahmed ⚾", "Matt Henry ⚾", "Rahul Chahar ⚾"],
  ...
  "MI": ["Hardik Pandya (c) ⚡", "Rohit Sharma 🏏", "Suryakumar Yadav 🏏", "Tilak Varma 🏏", "Jasprit Bumrah ⚾", "Trent Boult ⚾", "Deepak Chahar ⚾", "Mitchell Santner ⚡", "Corbin Bosch ⚡", "Quinton de Kock (wk) 🧤", "Sherfane Rutherford 🏏", "Ryan Rickelton (wk) 🧤", "Naman Dhir ⚡"],
  ...
  "RR": ["Riyan Parag (c) ⚡", "Yashasvi Jaiswal 🏏", "Dhruv Jurel (wk) 🧤", "Ravindra Jadeja ⚡", "Shimron Hetmyer 🏏", "Vaibhav Suryavanshi 🏏", "Donovan Ferreira (wk) 🧤", "Ravi Bishnoi ⚾", "Sandeep Sharma ⚾", "Nandre Burger ⚾", "Tushar Deshpande ⚾", "Sam Curran ⚡", "Yudhvir Singh Charak ⚡", "Shubham Dubey 🏏"],
  "SRH": ["Ishan Kishan (c)(wk) 🧤", "Travis Head 🏏", "Abhishek Sharma ⚡", "Heinrich Klaasen (wk) 🧤", "Aniket Verma 🏏", "Nitish Kumar Reddy ⚡", "Salil Arora (wk) 🧤", "Harsh Dubey ⚡", "Shivang Kumar ⚡", "Jaydev Unadkat ⚾", "Eshan Malinga ⚾"],
  "DC": ["Axar Patel (c) ⚡", "KL Rahul (wk) 🧤", "Pathum Nissanka 🏏", "Ben Duckett 🏏", "Tristan Stubbs 🏏", "David Miller 🏏", "Nitish Rana 🏏", "Ashutosh Sharma 🏏", "Kuldeep Yadav ⚾", "Mitchell Starc ⚾", "T. Natarajan ⚾", "Mukesh Kumar ⚾"],
  ...
  "GT": ["Shubman Gill (c) 🏏", "Sai Sudharsan 🏏", "Jos Buttler (wk) 🧤", "Glenn Phillips ⚡", "Washington Sundar ⚡", "Rahul Tewatia ⚡", "Rashid Khan ⚡", "Kagiso Rabada ⚾", "Mohammed Siraj ⚾", "Prasidh Krishna ⚾", "Arshad Khan ⚡"],
  "LSG": ["Rishabh Pant (c)(wk) 🧤", "Nicholas Pooran (wk) 🧤", "Josh Inglis (wk) 🧤", "Aiden Markram 🏏", "Mitchell Marsh ⚡", "Ayush Badoni 🏏", "Mohammed Shami ⚾", "Anrich Nortje ⚾", "Avesh Khan ⚾", "Mohsin Khan ⚾", "Prince Yadav ⚾", "Manimaran Siddharth ⚾", "Himmat Singh 🏏", "Digvesh Singh Rathi ⚾"]
};
